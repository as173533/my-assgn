...
<h2 style="font-style: italic !important; text-align: center; color: #000; font-size: 18px; padding: 0px !important; margin: 0px 0px 0px 0px !important; ">(Institute Of Computer Education Center)</h2>
<h2 style="font-style: italic !important; text-align: center; color: #000; font-size: 18px; padding: 0px !important; margin: 0px 0px 0px 0px !important; ">Dhurwa Bus Stand Ranchi, Jharkhand</h2>
<h2 style="text-align: center; color: #4398B5; font-size: 14px; padding: 0px !important; margin: 0px 0px 0px 0px !important; ">Certificate Verification: www.ditechnical.in/certificate-verification</h2>
...
<p style="text-align: center; color: #1f0a85; font-size: 18px; padding: 0px !important; margin: 0px 0px 0px 0px !important;">Certificate No: <b>{{$assigncourse->certificate_no}}</b></p>
<h2 style="font-style: italic !important; text-align: left; color: #000; font-size: 25px; font-weight: bold; padding: 0px 0px 0px 10px !important; margin: 0px 0px 0px 0px !important; ">Awards This Certificate Of: <span>{{$assigncourse->course->course_type}}</span></h2>
<table style="width: 100%; padding-top: 0px !important;">
	<tbody>
     ...
     <tr style="margin: 0px 0px 0px 10px !important;">
      <td style="color: #000; font-size: 20px; font-weight: 400; padding: 0px 0px 0px 10px !important;">Registration No <span style="padding-left: 0px !important;">:</span> <span>{{$assigncourse->user->registration_id}}</span></td>
     </tr>
     <tr style="margin: 0px 0px 0px 10px !important;">
     ...
     <tr style="margin: 0px 0px 0px 10px !important;">
      <td style="color: #000; font-size: 20px; font-weight: 400; padding: 0px 0px 0px 10px !important;">Father's Name <span style="padding-left: 10px !important;">:</span> <span>{{$assigncourse->user->father_name}}</span></td>
     </tr>
     <tr style="margin: 0px 0px 0px 10px !important;">
      <td style="color: #000; font-size: 20px; font-weight: 400; padding: 0px 0px 0px 10px !important;">Mother's Name <span style="padding-left: 4px !important;">:</span> <span>{{$assigncourse->user->mother_name}}</span></td>
     </tr>
     <tr style="margin: 0px 0px 0px 10px !important;">
...
?>
<h2 style="text-align: left; color: #2A1772; font-weight: 400; font-size: 20px; padding: 0px 0px 0px 10px !important; margin: 0px 0px 0px 0px !important;">Having successfully qualified all the theory and practical modules of the DI TECHNICAL</h2>


<p style="padding: 0px 0px 0px 10px !important; font-size:20px; font-style: italic !important;">Has been awarded <span class="underline-1" style="border-bottom: 1px solid #000; width: 76%; display: inline-block; text-align: center;">{{$assigncourse->course->course_type}}</span></p>
...
<p style="padding: 0px 0px 0px 10px !important; font-size:20px; font-style: italic !important;">with Grade <span class="underline-1" style="border-bottom: 1px solid #000; width: 18%; display: inline-block; text-align: center;">
       ...
       B+
       @endif
    </span> and <span class="underline-1" style="border-bottom: 1px solid #000; width: 18%; display: inline-block; text-align: center;">{{$assigncourse->course->time*1.2}}</span> contact hours and course duration</p>
		...
		<tbody>
			<tr style="padding: 0px 0px 0px 0px !important; margin: 0px 0px 0px 0px !important;">
				<td style="text-align: center!important; padding: 0px 0px 0px 0px !important; margin: 0px 0px 0px 0px !important;">
					<img src="{{URL::asset('public/frontend/images/Center.png')}}" alt="" style="width: 85px; height: 85px; margin: 0px 0px 0px 0px !important; padding: 0px 0px 0px 0px !important; line-height: 0px !important;">
				</td>
				<td style="text-align: center!important; padding: 0px 0px 0px 0px !important; margin: 0px 0px 0px 0px !important;">
					<img src="{{URL::asset('public/frontend/images/Alka.png')}}" alt="" style="width: 142px; height: 28px; margin: 0px 0px 0px 0px !important; padding: 0px 0px 0px 0px !important; line-height: 0px !important;">
				</td>
				<td style="text-align: center!important; padding: 0px 0px 0px 0px !important; margin: 0px 0px 0px 0px !important;">
					<img src="{{URL::asset('public/frontend/images/dir.png')}}" alt="" style="width: 200px; height: 66px; margin: 0px 0px 0px 0px !important; padding: 0px 0px 0px 0px !important; line-height: 0px !important;">
				</td>
			</tr>
			<tr style="padding: 0px 0px 0px 0px !important; margin: 0px 0px 0px 0px !important;">
